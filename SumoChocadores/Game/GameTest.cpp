...
void GameTest::LoadContent(LPDIRECT3DDEVICE9 dev)
{
	//Inputs
	...
	sI.Import("bspTest15.dae", root, dev);
...
void GameTest::Update(LPDIRECT3DDEVICE9 dev)
{
	...
	if (m_Input->GetKey("Q"))
	{
		camera->m_Transform->Rotate(D3DXVECTOR3(0, 0.1f, 0));
		camera->View(dev, 60, 640, 480, 0.1f, 30);
	}
